...
public class DummyData{
  public static void generate(){
    ...
    lis.addStuff(user, item1, "1500", university, location, "Bicycles", description1, now, "yes");
    lis.addStuff(user, "PS3", price, university, location, "Electronics", description, now, bid);
    lis.addStuff("user2", "Thinkpad", price, university, location, "Electronics", description, now, bid);
    lis.addStuff("user3", "Nexus 4", price, university, location, "Cell Phones", description, now, bid);  
